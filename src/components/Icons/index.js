export const UploadIcon = ({ width = '2.8rem', height = '2.8rem', className }) => (
    <svg
        className={className}
        fill="currentColor"
        viewBox="0 0 48 48"
...
export const ChatIcon = ({ width = '2.8rem', height = '2.8rem', className }) => (
    <svg
        fill="currentColor"
        className={className}
        viewBox="0 0 48 48"
...
export const NotiIcon = ({ width = '2.8rem', height = '2.8rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
